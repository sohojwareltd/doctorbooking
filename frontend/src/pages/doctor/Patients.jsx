      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <DocCard padding={false} className="relative overflow-hidden border-[#30416f]/20 bg-gradient-to-r from-[#283766] via-[#3d466b] to-[#be7a4b] text-white shadow-[0_20px_40px_-28px_rgba(33,45,80,0.85)] md:h-[260px]">
          ...
          <div className="relative grid gap-3 px-5 py-4 md:grid-cols-[minmax(0,1fr)_320px] md:px-6">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-white/70">Patient Registry</p>
              <h2 className="mt-1 text-2xl font-black tracking-tight text-white">Patient Directory</h2>
              <p className="mt-1 text-sm text-white/80">Dynamic patient list with contact intelligence and quick actions.</p>
