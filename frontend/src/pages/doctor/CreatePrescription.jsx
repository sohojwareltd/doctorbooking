                        ...
                        <div className="flex flex-wrap items-center justify-between gap-4">
                            <div className="flex flex-wrap items-center gap-4">
                                <div className="flex items-center gap-2">
                                    <span className="text-xs font-semibold uppercase text-slate-400">Patient:</span>
                                    <span className="text-base font-semibold text-slate-800">{state.patient.name || '—'}</span>
                                </div>
                                ...
                                {state.patient.gender && (
                                    <div className="text-sm text-slate-600">{state.patient.gender}</div>
                                )}
                                {state.patient.weight && (
                                    <div className="text-sm text-slate-600">{state.patient.weight} kg</div>
                                )}
                            ...
                            <div className="mb-6 rounded-lg border-2 border-dashed border-slate-200 bg-slate-50 p-4">
                                ...
                                <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-6 xl:grid-cols-6">
                                    <div>
                                        ...
                                        <input
                                            className="w-full rounded-md bg-slate-50/50 px-2 py-1.5 text-sm text-slate-900 doc-input-focus"
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-1">
                                            ...
                                            />
                                            <select
                                                className="w-20 rounded-md bg-slate-50/50 px-1 py-1.5 text-xs text-slate-900 doc-input-focus"
                                                    ...
                                                    {(state.medicines || []).map((m, idx) => (
                                                        <div key={idx} className="group/med flex items-start gap-2 rounded border border-slate-200 bg-white p-2 transition hover:border-[#b9caee] hover:bg-slate-50">
                                                            ...
                                                            <div className="flex-1 grid grid-cols-6 gap-2">
                                                                <input
                                                                    className="col-span-2 rounded bg-slate-50/50 px-3 py-1.5 text-sm text-slate-900 doc-input-focus"
                                                                    value={m.name}
                                                                    onChange={(e) => {
                                                                ...
                                                                />
                                                                <input
                                                                    className="rounded bg-slate-50/50 px-3 py-1.5 text-sm text-slate-900 doc-input-focus"
                                                                    value={m.strength}
                                                                    onChange={(e) => dispatch({
                                                                        type: 'setArrayItem',
                                                                        path: ['medicines'],
