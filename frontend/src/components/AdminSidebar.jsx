...
import { BarChart3, CalendarCheck2, LayoutDashboard, PlusCircle, Settings, Users, User } from 'lucide-react';
    ...
    <GlassCard variant="solid" hover={false} className="flex flex-col h-full overflow-hidden border-0 p-0">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-4 text-center">
          <h2 className="text-lg font-bold text-[#005963]">{user?.name || 'Admin Name'}</h2>
          {user?.email && (
