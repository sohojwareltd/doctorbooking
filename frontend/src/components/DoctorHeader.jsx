...
export default function DoctorHeader({ title = '', onMenuClick, collapsed = false, onToggleCollapse }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-30 flex h-16 items-center justify-between border-b border-[#EDEDED] bg-white px-4 shadow-sm md:px-8" style={{ left: undefined }} id="doc-header">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 z-40 mt-2 w-48 rounded-lg border border-gray-200 bg-white py-2 shadow-lg">
