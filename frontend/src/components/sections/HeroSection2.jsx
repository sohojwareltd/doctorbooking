...
export default function HeroSection2({ doctor }) {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 grid min-h-[calc(100vh-80px)] grid-cols-1 items-center gap-8 px-4 sm:px-8 lg:grid-cols-2 lg:gap-16 lg:px-12 xl:px-24">
                <motion.div
                    style={{ opacity }}
                ...
                >
                    ...
                    <motion.h1
                        ...
                        className="mb-6 text-5xl font-black tracking-tight text-[#005963] sm:text-6xl lg:text-7xl"
                    >
                        {doctorName}
                    </motion.h1>
                    ...
                    >
                        {paragraphs.map((paragraph, idx) => (
                            <motion.p
                                ...
                                className="text-lg leading-relaxed text-[#686a6f]"
                            >
                                {paragraph}
                            </motion.p>
                        ))}
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            className="rounded-xl border-2 border-[#005963]/30 px-6 py-3 text-sm font-semibold text-[#005963] backdrop-blur-sm transition-all hover:border-[#005963] hover:bg-[#005963]/10"
                ...
                >
                    <div className="relative w-full max-w-sm">
                        <div className="relative z-20 aspect-[3/4] w-full overflow-hidden rounded-3xl border-2 border-[#00acb1]/30 bg-white shadow-2xl">
                            <img
                                src={imageUrl}
                                alt={imageAlt}
